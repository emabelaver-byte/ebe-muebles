...
// 🛑 ¡ATENCIÓN! PEGA AQUÍ TUS CÓDIGOS DE FIREBASE 🛑
// Copia estos datos de tu consola de Firebase y reemplaza los de abajo.
...
const App = () => {
  ...
  const handleAdminLogin = async () => {
    ...
    try {
      ...
      if (error.code === 'auth/unauthorized-domain') {
        ...
        alert("API Key inválida. \n\nPor favor, asegúrate de haber pegado tus credenciales reales de Firebase en el código.");
      } else {
  ...
  const addGalleryImage = () => {
    if (newImage.url) {
      ...
      setGaleria([...galeria, { id: Date.now(), src: processedUrl, alt: newImage.alt || 'Nuevo Trabajo' }]);
      setNewImage({ url: '', alt: '' });
    }
  };
...
// Copia estos datos de tu consola de Firebase y reemplaza los de abajo.
const firebaseConfig = {
  apiKey: "TU_API_KEY_AQUI",           // Copia de Firebase: apiKey
  authDomain: "TU_DOMINIO.firebaseapp.com", // Copia de Firebase: authDomain
  projectId: "TU_PROJECT_ID",          // Copia de Firebase: projectId
  storageBucket: "TU_BUCKET.appspot.com", // Copia de Firebase: storageBucket
  messagingSenderId: "TU_SENDER_ID",   // Copia de Firebase: messagingSenderId
  appId: "TU_APP_ID"                   // Copia de Firebase: appId
};
